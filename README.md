...
I'm an undergrad developer mainly working with **Java**, **Spring Boot**, and **MySQL** to build backend systems and full applications.  
I've also built simple desktop apps using **JavaFX**, and I occasionally work with **React** for frontend setups when needed.
